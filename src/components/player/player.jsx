...
const Player = ({currentFilm, isCurrentFilmLoaded, loadCurrentFilm, redirectToUrl}) => {
    ...
    (isCurrentFilmLoaded) ?
      <React.Fragment>
        ...
        <div className="player">
          ...
          <video src={currentFilm.videoLink} className="player__video" poster={currentFilm.posterImage} autoPlay ref={videoRef}></video>
